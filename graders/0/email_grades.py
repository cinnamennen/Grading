...
with SSHTunnelForwarder(
    ...
    for student in cursor:
        grade = (student['correct'] * .9) + (student['quality'])
        ...
        data = {
            ...
            "quality_points": student['quality'],
            "days_late": student['late'],
            "late_factor": 10 * student['late'],
            "comments": student['reasoning']
        }
        ...
        message = CreateMessage("TA_NET_ID@vols.utk.edu", student["_id"]+"@vols.utk.edu", "lab0 grade", email_text)
